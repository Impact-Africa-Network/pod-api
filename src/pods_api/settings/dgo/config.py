...
DEFAULT_FILE_STORAGE = "pods_api.settings.dgo.utils.MediaRootS3BotoStorage"

STATICFILES_STORAGE = "pods_api.settings.dgo.utils.StaticRootS3BotoStorage"
...
PRIVATE_FILE_STORAGE = "pods_api.settings.dgo.utils.MediaRootS3BotoStorage"
